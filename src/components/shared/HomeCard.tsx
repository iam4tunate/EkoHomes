...
export default function HomeCard({ home }: { home: Models.Document }) {
  ...
  return (
    <div className="border rounded-lg w-full py-4 px-3 max-sm:p-2.5 bg-white">
      <img
      ...
      />
      <div className="pt-4 font-geist500">{home.title}</div>
      <p className="text-[13px] leading-tight pt-2 pb-3">
      ...
      <div className="pt-6 flex items-center justify-between">
        <div className="">
          ...
          <p className="text-lg font-geist600">
